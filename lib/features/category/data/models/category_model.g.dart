...
void _categoryModelSerialize(
  ...
  writer.writeLong(offsets[0], object.bgColorValue);
...
CategoryModel _categoryModelDeserialize(
  ...
  object.bgColorValue = reader.readLong(offsets[0]);
...
extension CategoryModelByIndex on IsarCollection<CategoryModel> {
  Future<CategoryModel?> getByCategoryId(String categoryId) {
    return getByIndex(r'categoryId', [categoryId]);
  }

  CategoryModel? getByCategoryIdSync(String categoryId) {
  ...
  Future<List<CategoryModel?>> getAllByCategoryId(
      List<String> categoryIdValues) {
    final values = categoryIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'categoryId', values);
  }

  List<CategoryModel?> getAllByCategoryIdSync(List<String> categoryIdValues) {
    final values = categoryIdValues.map((e) => [e]).toList();
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      bgColorValueEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'bgColorValue',
        value: value,
      ));
    });
  }
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByBgColorValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bgColorValue', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByBgColorValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bgColorValue', Sort.desc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct>
      distinctByBgColorValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'bgColorValue');
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByKeywords() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, int, QQueryOperations> bgColorValueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'bgColorValue');
    });
  }
  ...
  QueryBuilder<CategoryModel, List<String>, QQueryOperations>
      keywordsProperty() {
    return QueryBuilder.apply(this, (query) {
